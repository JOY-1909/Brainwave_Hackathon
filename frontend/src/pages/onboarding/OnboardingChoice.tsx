...
import { FileUp, Keyboard, ArrowRight, Sparkles, ChevronLeft } from 'lucide-react';
...
export const OnboardingChoice = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-background px-4 py-8 md:p-12 relative">
      <div className="space-y-12 text-center max-w-7xl mx-auto pt-12 md:pt-0">
      ...
      {/* Back Button for logged in users - Moved to Bottom Center */}
      {isLoggedIn && (
